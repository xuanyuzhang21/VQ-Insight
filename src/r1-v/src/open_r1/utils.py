...
class GenerationMixin:
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        """
        # print(f'in GenerationMixin: input_ids is {input_ids}', flush=True)
    ...
    def generate(
        ...
        **kwargs,
        ...
        # tmp_input_ids = inputs["input_ids"]
        # print(f'in GenerationMixin generate forward, input_ids: {tmp_input_ids}', flush=True)
        # print(f'in GenerationMixin generate forward, inputs: {inputs}', flush=True)
        ...
        # print(f'in GenerationMixin generate forward, input_ids: {input_ids}, len(input_ids): {input_ids.size()}', flush=True)
        self.ori_input_ids = copy.deepcopy(input_ids)
        # print(f'in GenerationMixin generate forward, ori_input_ids: {self.ori_input_ids}', flush=True)
